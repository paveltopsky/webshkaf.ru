...
<body>
    ...
    <form class="panel" action="functions/save.php" method="POST">
      ...
      <div class="tabs">
        ...
        <div class="row align-items-end">
          ...
          <div class="col-6 d-flex justify-content-center align-items-center" style="height: 105px;">
        ...
        <div class="panel__design tabs__content active">
          <div class="panel__title">Основные параметры</div>
          <!-- Высота -->
          <div class="row">
          ...
          <!-- Наполнение -->
          <div class="panel__section seventh container">
          ...
          <!-- Фасады и двери -->
          <div class="panel__section fifth">
        ...
        <div class="panel__material tabs__content">
          ...
          <div class="row mt-4">
            <div class="col-12">
              <a a href="preview.html" target="_blank" class="link__open-preview">
          ...
          <div class="row">
            ...
            <div class="col-7">
              <select id="inputSelect_materialMain" class="flex">
                ...
                <option value="аруба_венге">Аруба венге</option>
                <option value="баменда_венге" selected>Баменда венге</option>
                <option value="берёза_майнау">Берёза майнау</option>
                ...
                <option value="гасиенда">Гасиенда</option>
                ...
                <option value="дуб_давос_трюфель">Дуб давос трюфель</option>
                ...
                <option value="клён_медовый">Клён медовый</option>
                <option value="клён_шампань">Клён шампань</option>
                <option value="клён_штанберг">Клён штанберг</option>
                <option value="ольха">Ольха</option>
                <option value="ольха_красная">Ольха красная</option>
                <option value="орех">Орех</option>
                <option value="орех_аида_табак">Орех аида табак</option>
                ...
                <option value="эбони_тёмный">Эбони тёмный</option>
                <option value="эвкалипт_мистери">Эвкалипт мистери</option>
                <option value="яблоня_локарн">Яблоня локарн</option>
                <option value="ясень_анкор">Ясень анкор</option>
                <option value="ясень_шимо">Ясень шимо</option>
                <option disabled>- - - Цвет - - -</option>
                <option value="аква_голубой">Аква голубой</option>
                <option value="алебастр_белый">Алебастр белый</option>
                <option value="антрацит">Антрацит</option>
                <option value="бежевый_песок">Бежевый песок</option>
                <option value="белый">Белый</option>
                <option value="ванильный_жёлтый">Ванильный жёлтый</option>
                <option value="голубой_горизонт">Голубой горизонт</option>
                <option value="голубой_делфт">Голубой делфт</option>
                <option value="голубой_лёд">Голубой лёд</option>
                <option value="жёлтый_бриллиант">Жёлтый бриллиант</option>
                <option value="жёлтый_пастельный">Жёлтый пастельный</option>
                <option value="зелёный">Зелёный</option>
                <option value="зелёный_изумруд">Зелёный изумруд</option>
                <option value="зелёный_лаймовый">Зелёный лаймовый</option>
                <option value="зелёный_лес">Зелёный лес</option>
                <option value="зелёный_степной">Зелёный степной</option>
                <option value="зелёный_яблоко">Зелёный яблоко</option>
                <option value="красный_бургунский">Красный бургунский</option>
                <option value="красный_китайский">Красный китайский</option>
                <option value="лаванда">Лаванда</option>
                <option value="мандариновый">Мандариновый</option>
                <option value="оникс_серый">Оникс серый</option>
                <option value="оранжевый_коралл">Оранжевый коралл</option>
                ...
                <option value="фиолетовый_крокус">Фиолетовый крокус</option>
                <option value="чёрный_графит">Чёрный графит</option>
                <option value="черно-коричневый">Черно-коричневый</option>
                <option disabled>- - - Металл - - -</option>
                <option value="алюминий">Алюминий</option>
                <option value="алюминий_матированный">Алюминий матированный</option>
                <option value="маталлик_золото">Маталлик золото</option>
          ...
          <div class="row">
            ...
            <div class="col-7">
              <select id="inputSelect_materialFacade" class="flex">
                ...
                <option value="арабеска">Арабеска</option>
                <option value="аруба_венге">Аруба венге</option>
                <option value="баменда_венге">Баменда венге</option>
                <option value="берёза_майнау">Берёза майнау</option>
                <option value="бук">Бук</option>
                <option value="бук_бавария">Бук бавария</option>
                <option value="бук_кантри">Бук кантри</option>
          ...
          <div class="row">
            ...
            <div class="col-7">
              <select id="inputSelect_materialWall" class="flex">
                ...
                <option value="голубой_лёд">Голубой лёд</option>
                <option value="жёлтый_бриллиант">Жёлтый бриллиант</option>
                <option value="жёлтый_пастельный" selected>Жёлтый пастельный</option>
                <option value="зелёный">Зелёный</option>
                <option value="зелёный_изумруд">Зелёный изумруд</option>
                <option value="зелёный_лаймовый">Зелёный лаймовый</option>
                <option value="зелёный_лес">Зелёный лес</option>
          ...
          <div class="row">
            ...
            <div class="col-7">
              <select id="inputSelect_materialHand" class="flex">
                ...
                <option value="аква_голубой">Аква голубой</option>
                <option value="алебастр_белый">Алебастр белый</option>
                <option value="антрацит" selected>Антрацит</option>
                <option value="бежевый_песок">Бежевый песок</option>
                <option value="белый">Белый</option>
                <option value="ванильный_жёлтый">Ванильный жёлтый</option>
                <option value="голубой_горизонт">Голубой горизонт</option>
          ...
          <div class="row">
            ...
            <div class="col-7">
              <select id="inputSelect_materialLeg" class="flex">
                ...
                <option value="серый_асфальт">Серый асфальт</option>
                <option value="фиолетовый_крокус">Фиолетовый крокус</option>
                <option value="чёрный_графит" selected>Чёрный графит</option>
                <option value="черно-коричневый">Черно-коричневый</option>
                <option disabled>- - - Металл - - -</option>
                <option value="алюминий">Алюминий</option>
                <option value="алюминий_матированный">Алюминий матированный</option>
  ...
  <script type="module">
    ...
    // по умолчанию цвета
    prop.textureWordMain = 'баменда_венге';
    prop.textureWordFacade = 'акация_лэйклэнд';
    prop.textureWordFill = 'акация_лэйклэнд';
    prop.textureWordWall = 'жёлтый_пастельный';
    prop.textureWordHand = 'антрацит';
    prop.textureWordRod = 'антрацит';
    prop.textureWordLeg = 'чёрный_графит';
    ...
    var reconstruct = function () {
      ...
      part.entresol = new THREE.Mesh(geometryEntresol, material.main);
    ...
    var priceCalc = function() {
      ...
      var rate = {
        ...
        rack_l: $('#rack_l_php').html(),
        rack_r: $('#rack_r_php').html(),
        roof: $('#roof_php').html(),
      };
  ...
  <?php
    ...
    $sql = "SELECT rack_l, rack_r, roof, material FROM rate";
    ...
    // code
    echo "<div id='rack_l_php' class='d-none'>".$row['rack_l']."</div>";
    echo "<div id='rack_r_php' class='d-none'>".$row['rack_r']."</div>";
    echo "<div id='roof_php' class='d-none'>".$row['roof']."</div>";
